...
const expenseHeadSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      .addCase(getEstateExpenseHeads.pending, (state) => {
        state.listState = "isLoading";
        state.error = null;
      })
      .addCase(getEstateExpenseHeads.fulfilled, (state, action: any) => {
      ...
      .addCase(getEstateExpenseHeads.rejected, (state, action: any) => {
    ...
    builder
      .addCase(getExpenseHeadById.pending, (state) => {
        state.getByIdState = "isLoading";
        state.error = null;
      })
      .addCase(getExpenseHeadById.fulfilled, (state, action: any) => {
        state.getByIdState = "succeeded";
        state.selected = action.payload?.data ?? action.payload ?? null;
      })
      .addCase(getExpenseHeadById.rejected, (state, action: any) => {
