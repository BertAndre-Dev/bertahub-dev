...
>("estateAdminChat/createChat", async (payload, { rejectWithValue }) => {
  try {
...
export const sendMessage = createAsyncThunk<
  ...
  SendMessagePayload,
  { rejectValue: RejectValue }
>("estateAdminChat/sendMessage", async (payload, { rejectWithValue }) => {
  try {
...
export const getChatHistory = createAsyncThunk<
  ...
  { rejectValue: RejectValue }
>(
  "estateAdminChat/getChatHistory",
...
export const getUserChats = createAsyncThunk<
  ...
  { status?: ChatStatus },
  { rejectValue: RejectValue }
>("estateAdminChat/getUserChats", async ({ status }, { rejectWithValue }) => {
  try {
...
export const getAgentChats = createAsyncThunk<
  ...
  { rejectValue: RejectValue }
>("estateAdminChat/getAgentChats", async ({ assignedOnly }, { rejectWithValue }) => {
  try {
    const params =
...
export const getChatById = createAsyncThunk<
  ...
  { chatId: string },
  { rejectValue: RejectValue }
>("estateAdminChat/getChatById", async ({ chatId }, { rejectWithValue }) => {
  try {
    const id = chatId?.trim();
    if (!id || !isValidObjectId(id)) {
      return rejectWithValue(invalidIdMessage("chatId"));
...
export const updateChatStatus = createAsyncThunk<
  ...
  UpdateChatStatusPayload,
  { rejectValue: RejectValue }
>("estateAdminChat/updateChatStatus", async (payload, { rejectWithValue }) => {
  try {
...
export const closeChat = createAsyncThunk<
  ...
  { chatId: string },
  { rejectValue: RejectValue }
>("estateAdminChat/closeChat", async ({ chatId }, { rejectWithValue }) => {
  try {
    const id = chatId?.trim();
    if (!id || !isValidObjectId(id)) {
      return rejectWithValue(invalidIdMessage("chatId"));
...
export const deleteMessage = createAsyncThunk<
  ...
  { messageId: string },
  { rejectValue: RejectValue }
>("estateAdminChat/deleteMessage", async ({ messageId }, { rejectWithValue }) => {
  try {
