...
const initialState: AdminAssetState = {
  categories: [],
...
export const { clearAdminAssetError, clearCurrentAsset } =
  adminAssetSlice.actions;
export default adminAssetSlice.reducer;

export const selectAdminAssetState = (state: RootState): AdminAssetState =>
  (state.adminAsset as AdminAssetState | undefined) ?? initialState;
