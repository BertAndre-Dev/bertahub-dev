...
export const superAdminNav = [
    { label: "Dashboard", icon: FiHome, path: '/dashboard/super-admin/dashboard' },
    { label: "Estate Management", icon: BsBuildings, path: '/dashboard/super-admin/estate' },
    { label: "Address Management", icon: BsBuildings, path: '/dashboard/super-admin/address' },
    { label: "User Management", icon: FiUsers, path: '/dashboard/super-admin/user' },
    { label: "Bills Management", icon: LuReceipt, path: '/dashboard/super-admin/bills' },
...
export const adminNav = [
    ...
    { label: "Address Management", icon: FiUsers, path: '/dashboard/admin/address' },
...
export const residentNav = [
    ...
    { label: "Visitor Management", icon: FiUsers, path: '/dashboard/resident/visitor' },
