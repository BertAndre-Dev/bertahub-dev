...
import { sendMessage } from "@/redux/slice/estate-admin/chat/estate-admin-chat-thunks";
...
export default function EstateAdminChatInput({ chatId }: Readonly<Props>) {
  const dispatch = useDispatch<AppDispatch>();
  const sendStatus = useSelector(
    (state: RootState) => state.estateAdminChat.sendMessageLoading,
  );
