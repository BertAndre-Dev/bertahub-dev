...
import { createChat } from "@/redux/slice/estate-admin/chat/estate-admin-chat-thunks";
...
export default function EstateAdminNewChatModal({ open, onClose }: Readonly<Props>) {
  ...
  const createStatus = useSelector(
    (state: RootState) => state.estateAdminChat.createChatLoading,
  );
