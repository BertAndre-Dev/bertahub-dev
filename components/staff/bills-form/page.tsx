        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between gap-3">
              <Label htmlFor="staff-bill-service-charge" className="font-medium">
                Service charge
              </Label>
              <button
                id="staff-bill-service-charge"
                type="button"
                role="switch"
            ...
            <div>
              <Label htmlFor="staff-bill-frequency">Frequency</Label>
              <Select
                id="staff-bill-frequency"
