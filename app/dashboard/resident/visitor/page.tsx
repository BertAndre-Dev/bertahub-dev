...
export default function VisitorPage() {
  ...
  const [viewingVisitor, setViewingVisitor] = useState<VisitorData | null>(
    null,
  );
  const [visitorToDelete, setVisitorToDelete] = useState<VisitorData | null>(
    null,
  );
  ...
  const columns = [
    ...
    },
    {
      key: "phone",
      header: "Phone",
      render: (item: VisitorData) => item.phone || "—",
    },
    {
      key: "purpose",
      header: "Purpose",
      render: (item: VisitorData) => item.purpose || "—",
    },
    {
      key: "isVerified",
      header: "Status",
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {viewingVisitor.visitorCode || "—"}
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <span
                    className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium ${
                      viewingVisitor.isVerified
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">
                        {viewingVisitor.createdAt
                          ? new Date(viewingVisitor.createdAt).toLocaleString(
                              "en-US",
                              {
                                dateStyle: "medium",
                                timeStyle: "short",
                  ...
                  {viewingVisitor.updatedAt && (
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900">
                          {new Date(viewingVisitor.updatedAt).toLocaleString(
                            "en-US",
                            {
                              dateStyle: "medium",
                              timeStyle: "short",
