...
import OperationsReportingTypesTab from "./components/operations-reporting/OperationsReportingTypesTab";
import OperationsReportingReportsTab from "./components/operations-reporting/OperationsReportingReportsTab";
    ...
    <div className="relative space-y-6">
      ...
      >
        <div className="flex flex-col">
          <h1 className="font-heading text-3xl font-bold">Maintenance & Report</h1>
          <p className="mt-1 text-muted-foreground">
            Manage maintenance schedules and operations reports for{" "}
            <span className="font-bold uppercase text-black">{estateName}</span>.
          </p>
        </div>

        {/* <div className="bg-red-200 p-4 border border-border rounded-lg mb-8"> */}
          <Tab
            titles={["Maintenance", "Operations Reporting"]}
                    ...
                    <Tab
                      ...
                      renderContent={(opsTab) => {
                        switch (opsTab) {
                          case "Reports":
                            return (
                              <OperationsReportingReportsTab estateId={estateId} />
                            );
                          case "Configure Report Type":
                            return (
                              <OperationsReportingTypesTab estateId={estateId} />
                            );
                          default:
                            return null;
                        }
