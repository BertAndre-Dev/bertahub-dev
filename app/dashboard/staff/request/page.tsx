...
import StaffRequestWorkflowConfigPanel from "@/components/staff/request/StaffRequestWorkflowConfigPanel";
...
const STAFF_REQUEST_TABS = ["Requests", "Workflow"];
    ...
    <div className="relative space-y-6">
      ...
      <Tab
        ...
        renderContent={(tab) => (
          ...
          >
            {tab === "Workflow" ? (
              <StaffRequestWorkflowConfigPanel
                estateId={estateId}
